...
struct DoActivitiesModel: Codable {
    let response: [Activities]
}
public struct Activities: Codable, Identifiable {
    public let id: Int
    let title: String
    let image: String
...
public extension Activities{
    static let mockActivity = Activities(id: 1,
                                         title: "Clay Elephant",
    ...
    static let mockActivities: [Activities] = [
        Activities(id: 1,
                   title: "Clay Elephant",
                   image: "https://example.com/images/elephant.jpg",
                   description: "Making a clay elephant is an engaging and educational DIY activity that introduces kids to the world of sculpting. Using modeling clay, ",
